...
public class Catalog {
  ...
  public static Map<String,Collection<Television>> findByBrands(String... brands) {
    final Map<String, Collection<Television>> tvs = new HashMap<>();
    for (Map.Entry<String, Collection<Television>> entry: tvs.entrySet()) {
      String brand = entry.getKey();
      Collection<Television> count= entry.getValue();
      tvs.put(brand,count);
    }
    return tvs;
  }
